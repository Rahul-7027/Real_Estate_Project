        ...
        >
            <form onSubmit={handleSubmit}>
                <Grid container spacing={2}>
                    <Grid item xs={12}>
                        <TextField fullWidth label="Client Id" type="number" required id="fullWidth outlined-error"
                            value={id}
                            onChange={(e) => setFormData({ ...formData, id: e.target.value.replace(/[^0-9]/g, "") })}
                        />
                    </Grid>
                    <Grid item xs={12}>
                    ...
                    <Grid item xs={12}>
                        <TextField fullWidth label="Client Contact No" type="number" required id="fullWidth"
                            value={contact}
                            onChange={(e) => setFormData({ ...formData, contact: e.target.value.replace(/[^0-9]/g, "") })} />
                    </Grid>
                    <Grid item xs={12}>
                        <TextField fullWidth label="Client Pan No" type="number" required id="fullWidth"
                            value={pan}
                            onChange={(e) => setFormData({ ...formData, pan: e.target.value.replace(/[^0-9]/g, "") })} />
                    </Grid>
                    <Grid item xs={12}>
                        <TextField fullWidth label="Client Aadhaar No" type="number" required id="fullWidth"
                            value={aadhaar}
